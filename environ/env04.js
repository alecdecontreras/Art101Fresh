...
function addFourLegged(fourLegged, bcolor){
    $("#output").html("<img id='mypic' src='exercises/images/IMG_6476.png'>");
}

$("#showFourLeggeds").click(function () {

    $("body").append('<img id="tule_elk" src="tule_elk.png"> </img>')
